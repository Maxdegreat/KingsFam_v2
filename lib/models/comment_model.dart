...
class Comment extends Equatable {
  ...
  List<Object?> get props =>
      [id, postId, author, content, date, highId]; //3do the props
  ...
  Map<String, dynamic> toDoc() {
    return {
      ...
      'author': FirebaseFirestore.instance
          ...
          .doc(author.id), //5 do the copy with
      'content': content,
      'date': Timestamp.now(),
      'highId' : highId,
    };
  ...
  static Future<Comment?> fromDoc(DocumentSnapshot doc) async {
    final data =
        doc.data() as Map<String, dynamic>; //5ith do factory or reference fac
